### Фичи
 - [:trophy:] живой поиск по категориям
 - [:trophy:] показ популярных товаров в категории на странице товара
 - [:trophy:] на странице корзины показываются сопутсвующие товары относительно положенных в нее предметов
 - [:trophy:] учитывание региона поставки товаров
